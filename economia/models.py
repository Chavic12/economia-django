...
class IndicadorEconomico(models.Model):
    ...
    def calculate_subindice(self):
        min_presupuesto = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('presupuesto_anual'))['presupuesto_anual__min']
        max_presupuesto = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('presupuesto_anual'))['presupuesto_anual__max']
        ...
        min_monto_residencial = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('monto_residencial'))['monto_residencial__min']
        max_monto_residencial = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('monto_residencial'))['monto_residencial__max']
        ...
        min_monto_residencial_industrial = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('monto_residencial_industrial'))['monto_residencial_industrial__min']
        max_monto_residencial_industrial = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('monto_residencial_industrial'))['monto_residencial_industrial__max']
        ...
        min_ingresos_fiscales = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('ingresos_fiscales'))['ingresos_fiscales__min']
        max_ingresos_fiscales = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('ingresos_fiscales'))['ingresos_fiscales__max']
        ...
        min_ingresos_preasignaciones = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('ingresos_preasignaciones'))['ingresos_preasignaciones__min']
        max_ingresos_preasignaciones = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('ingresos_preasignaciones'))['ingresos_preasignaciones__max']
        ...
        min_ingresos_credito = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('ingresos_credito'))['ingresos_credito__min']
        max_ingresos_credito = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('ingresos_credito'))['ingresos_credito__max']
        ...
        min_ingresos_asistencia = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('ingresos_asistencia'))['ingresos_asistencia__min']
        max_ingresos_asistencia = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('ingresos_asistencia'))['ingresos_asistencia__max']
        ...
        min_ingresos_anticipos = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('ingresos_anticipos'))['ingresos_anticipos__min']
        max_ingresos_anticipos = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('ingresos_anticipos'))['ingresos_anticipos__max']
        ...
        min_ingresos_totales = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('ingresos_totales'))['ingresos_totales__min']
        max_ingresos_totales = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('ingresos_totales'))['ingresos_totales__max']
        ...
        min_ingresos_ambiental_fiscales = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('ingresos_ambiental_fiscales'))['ingresos_ambiental_fiscales__min']
        max_ingresos_ambiental_fiscales = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('ingresos_ambiental_fiscales'))['ingresos_ambiental_fiscales__max']
        ...
        min_ingresos_ambiental_preasignaciones = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('ingresos_ambiental_preasignaciones'))['ingresos_ambiental_preasignaciones__min']
        max_ingresos_ambiental_preasignaciones = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('ingresos_ambiental_preasignaciones'))['ingresos_ambiental_preasignaciones__max']
        ...
        min_ingresos_totales_ambiental = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Min('ingresos_totales_ambiental'))['ingresos_totales_ambiental__min']
        max_ingresos_totales_ambiental = IndicadorEconomico.objects.filter(anio=self.anio).aggregate(Max('ingresos_totales_ambiental'))['ingresos_totales_ambiental__max']
...
class IndicadorInstitucional(models.Model):
    ...
    def calculate_subindice(self):
        min_funcionarios = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Min('funcionarios_tiempo_completo'))['funcionarios_tiempo_completo__min']
        max_funcionarios = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Max('funcionarios_tiempo_completo'))['funcionarios_tiempo_completo__max']
        funcionarios_normalized = 9 * ((float(self.funcionarios_tiempo_completo) - min_funcionarios) / (max_funcionarios - min_funcionarios)) + 1

        min_cobertura = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Min('cobertura_km_barrido_publicas'))['cobertura_km_barrido_publicas__min']
        max_cobertura = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Max('cobertura_km_barrido_publicas'))['cobertura_km_barrido_publicas__max']
        ...
        min_personas_servicio_barrido = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Min('personas_servicio_barrido'))['personas_servicio_barrido__min']
        max_personas_servicio_barrido = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Max('personas_servicio_barrido'))['personas_servicio_barrido__max']
        ...
        min_personas_ambiental = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Min('personas_gestion_ambiental'))['personas_gestion_ambiental__min']
        max_personas_ambiental = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Max('personas_gestion_ambiental'))['personas_gestion_ambiental__max']
        ...
        min_energia_kWh = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Min('energia_kWh'))['energia_kWh__min']
        max_energia_kWh = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Max('energia_kWh'))['energia_kWh__max']
        energia_kwh_nomalized = 9 * ((float(self.energia_kWh) - float(min_energia_kWh)) / (float(max_energia_kWh) - float(min_energia_kWh))) + 1

        min_energia_valor = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Min('energia_valor'))['energia_valor__min']
        max_energia_valor = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Max('energia_valor'))['energia_valor__max']
        ...
        min_combustible_diesel = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Min('combustible_diesel'))['combustible_diesel__min']
        max_combustible_diesel = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Max('combustible_diesel'))['combustible_diesel__max']
        ...
        min_combustible_extra = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Min('combustible_extra'))['combustible_extra__min']
        max_combustible_extra = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Max('combustible_extra'))['combustible_extra__max']
        ...
        min_combustible_super = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Min('combustible_super'))['combustible_super__min']
        max_combustible_super = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Max('combustible_super'))['combustible_super__max']
        ...
        min_num_productos = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Min('num_productos'))['num_productos__min']
        max_num_productos = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Max('num_productos'))['num_productos__max']
        productos_nomalized = 9 * ((float(self.num_productos) - float(min_num_productos)) / (float(max_num_productos) - float(min_num_productos))) + 1


        min_num_cortes_servicio = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Min('num_cortes_servicio'))['num_cortes_servicio__min']
        max_num_cortes_servicio = IndicadorInstitucional.objects.filter(anio=self.anio).aggregate(Max('num_cortes_servicio'))['num_cortes_servicio__max']
...
class IndicadorSocial(models.Model):
    ...
    def calculate_subindice(self):
        ...
        min_num_vehiculos = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('num_vehiculos'))['num_vehiculos__min']
        max_num_vehiculos = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('num_vehiculos'))['num_vehiculos__max']
        ...
        min_capacidad_tone_vehiculos = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('capacidad_tone_vehiculos'))['capacidad_tone_vehiculos__min']
        max_capacidad_tone_vehiculos = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('capacidad_tone_vehiculos'))['capacidad_tone_vehiculos__max']
        ...
        min_porcentaje_barrido = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('porcentaje_barrido'))['porcentaje_barrido__min']
        max_porcentaje_barrido = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('porcentaje_barrido'))['porcentaje_barrido__max']
        ...
        min_porcentaje_barrido_urbanas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('porcentaje_barrido_urbanas'))['porcentaje_barrido_urbanas__min']
        max_porcentaje_barrido_urbanas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('porcentaje_barrido_urbanas'))['porcentaje_barrido_urbanas__max']
        ...
        min_porcentaje_barrido_rurales = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('porcentaje_barrido_rurales'))['porcentaje_barrido_rurales__min']
        max_porcentaje_barrido_rurales = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('porcentaje_barrido_rurales'))['porcentaje_barrido_rurales__max']
        ...
        min_porcentaje_residuos = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('porcentaje_residuos'))['porcentaje_residuos__min']
        max_porcentaje_residuos = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('porcentaje_residuos'))['porcentaje_residuos__max']
        ...
        min_proyectos_conservacion_agua = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('proyectos_conservacion_agua'))['proyectos_conservacion_agua__min']
        max_proyectos_conservacion_agua = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('proyectos_conservacion_agua'))['proyectos_conservacion_agua__max']
        ...
        min_abast_agua_horas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('abast_agua_horas'))['abast_agua_horas__min']
        max_abast_agua_horas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('abast_agua_horas'))['abast_agua_horas__max']
        ...
        min_area_m2_institucion = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('area_m2_institucion'))['area_m2_institucion__min']
        max_area_m2_institucion = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('area_m2_institucion'))['area_m2_institucion__max']
        ...
        min_area_m2_parques = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('area_m2_parques'))['area_m2_parques__min']
        max_area_m2_parques = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('area_m2_parques'))['area_m2_parques__max']
        ...
        min_area_m2_plazas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('area_m2_plazas'))['area_m2_plazas__min']
        max_area_m2_plazas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('area_m2_plazas'))['area_m2_plazas__max']
        ...
        min_area_m2_jardines = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('area_m2_jardines'))['area_m2_jardines__min']
        max_area_m2_jardines = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('area_m2_jardines'))['area_m2_jardines__max']
        ...
        min_area_m2_parterres = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('area_m2_parterres'))['area_m2_parterres__min']
        max_area_m2_parterres = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('area_m2_parterres'))['area_m2_parterres__max']
        ...
        min_area_m2_riberas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('area_m2_riberas'))['area_m2_riberas__min']
        max_area_m2_riberas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('area_m2_riberas'))['area_m2_riberas__max']
        ...
        min_area_m2_estadios = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('area_m2_estadios'))['area_m2_estadios__min']
        max_area_m2_estadios = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('area_m2_estadios'))['area_m2_estadios__max']
        ...
        min_area_m2_urbanas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('area_m2_urbanas'))['area_m2_urbanas__min']
        max_area_m2_urbanas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('area_m2_urbanas'))['area_m2_urbanas__max']
        ...
        min_area_m2_canchas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('area_m2_canchas'))['area_m2_canchas__min']
        max_area_m2_canchas = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('area_m2_canchas'))['area_m2_canchas__max']
        ...
        min_area_total_hect = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Min('area_total_hect'))['area_total_hect__min']
        max_area_total_hect = IndicadorSocial.objects.filter(anio=self.anio).aggregate(Max('area_total_hect'))['area_total_hect__max']
...
class IndicadorAmbiental(models.Model):
    ...
    def calculate_subindice(self):
        ...
        min_area_sanitarios = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('area_sanitarios'))['area_sanitarios__min']
        max_area_sanitarios = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('area_sanitarios'))['area_sanitarios__max']
        ...
        min_num_botaderos = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('num_botaderos'))['num_botaderos__min']
        max_num_botaderos = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('num_botaderos'))['num_botaderos__max']
        ...
        min_area_botaderos = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('area_botaderos'))['area_botaderos__min']
        max_area_botaderos = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('area_botaderos'))['area_botaderos__max']
        ...
        min_total_residuos_tone = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_residuos_tone'))['total_residuos_tone__min']
        max_total_residuos_tone = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_residuos_tone'))['total_residuos_tone__max']
        ...
        min_total_residuos_solidos = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_residuos_solidos'))['total_residuos_solidos__min']
        max_total_residuos_solidos = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_residuos_solidos'))['total_residuos_solidos__max']
        ...
        min_total_residuos_peligroso_ton = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_residuos_peligroso_ton'))['total_residuos_peligroso_ton__min']
        max_total_residuos_peligroso_ton = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_residuos_peligroso_ton'))['total_residuos_peligroso_ton__max']
        ...
        min_total_residuos_organicos_ton = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_residuos_organicos_ton'))['total_residuos_organicos_ton__min']
        max_total_residuos_organicos_ton = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_residuos_organicos_ton'))['total_residuos_organicos_ton__max']
        ...
        min_total_residuos_inorganicos_ton = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_residuos_inorganicos_ton'))['total_residuos_inorganicos_ton__min']
        max_total_residuos_inorganicos_ton = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_residuos_inorganicos_ton'))['total_residuos_inorganicos_ton__max']
        ...
        min_total_residuos = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_residuos'))['total_residuos__min']
        max_total_residuos = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_residuos'))['total_residuos__max']
        ...
        min_residuos_urbanos_reciclaje = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('residuos_urbanos_reciclaje'))['residuos_urbanos_reciclaje__min']
        max_residuos_urbanos_reciclaje = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('residuos_urbanos_reciclaje'))['residuos_urbanos_reciclaje__max']
        ...
        min_total_residuos_urbanos = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_residuos_urbanos'))['total_residuos_urbanos__min']
        max_total_residuos_urbanos = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_residuos_urbanos'))['total_residuos_urbanos__max']
        ...
        min_total_residuos_solidos_peligrososo = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_residuos_solidos_peligrososo'))['total_residuos_solidos_peligrososo__min']
        max_total_residuos_solidos_peligrososo = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_residuos_solidos_peligrososo'))['total_residuos_solidos_peligrososo__max']
        ...
        min_captacion_agua_superficial = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('captacion_agua_superficial'))['captacion_agua_superficial__min']
        max_captacion_agua_superficial = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('captacion_agua_superficial'))['captacion_agua_superficial__max']
        ...
        min_captacion_agua_subterranea = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('captacion_agua_subterranea'))['captacion_agua_subterranea__min']
        max_captacion_agua_subterranea = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('captacion_agua_subterranea'))['captacion_agua_subterranea__max']
        ...
        min_volumen_total_superficial_subterranea = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('volumen_total_superficial_subterranea'))['volumen_total_superficial_subterranea__min']
        max_volumen_total_superficial_subterranea = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('volumen_total_superficial_subterranea'))['volumen_total_superficial_subterranea__max']
        ...
        min_volumen_bruto_dulce = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('volumen_bruto_dulce'))['volumen_bruto_dulce__min']
        max_volumen_bruto_dulce = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('volumen_bruto_dulce'))['volumen_bruto_dulce__max']
        ...
        min_volumen_agua_usuario = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('volumen_agua_usuario'))['volumen_agua_usuario__min']
        max_volumen_agua_usuario = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('volumen_agua_usuario'))['volumen_agua_usuario__max']
        ...
        min_total_agua_residual_recolectada = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_agua_residual_recolectada'))['total_agua_residual_recolectada__min']
        max_total_agua_residual_recolectada = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_agua_residual_recolectada'))['total_agua_residual_recolectada__max']
        ...
        min_total_residual_tratamiento = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_residual_tratamiento'))['total_residual_tratamiento__min']
        max_total_residual_tratamiento = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_residual_tratamiento'))['total_residual_tratamiento__max']
        ...
        min_num_plantas_tratamiento_residual = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('num_plantas_tratamiento_residual'))['num_plantas_tratamiento_residual__min']
        max_num_plantas_tratamiento_residual = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('num_plantas_tratamiento_residual'))['num_plantas_tratamiento_residual__max']
        ...
        min_capacidad_tratamiento_residual = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('capacidad_tratamiento_residual'))['capacidad_tratamiento_residual__min']
        max_capacidad_tratamiento_residual = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('capacidad_tratamiento_residual'))['capacidad_tratamiento_residual__max']
        ...
        min_total_agua_notratada_m3 = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_agua_notratada_m3'))['total_agua_notratada_m3__min']
        max_total_agua_notratada_m3 = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_agua_notratada_m3'))['total_agua_notratada_m3__max']
        ...
        min_total_agua_tratada_vertida = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_agua_tratada_vertida'))['total_agua_tratada_vertida__min']
        max_total_agua_tratada_vertida = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_agua_tratada_vertida'))['total_agua_tratada_vertida__max']
        ...
        min_total_agua_no_tratada_vertida = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('total_agua_no_tratada_vertida'))['total_agua_no_tratada_vertida__min']
        max_total_agua_no_tratada_vertida = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('total_agua_no_tratada_vertida'))['total_agua_no_tratada_vertida__max']
        ...
        min_catidad_agua_residual_alcatarillado_m3 = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('catidad_agua_residual_alcatarillado_m3'))['catidad_agua_residual_alcatarillado_m3__min']
        max_catidad_agua_residual_alcatarillado_m3 = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('catidad_agua_residual_alcatarillado_m3'))['catidad_agua_residual_alcatarillado_m3__max']
        ...
        min_consumo_agua = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Min('consumo_agua'))['consumo_agua__min']
        max_consumo_agua = IndicadorAmbiental.objects.filter(anio=self.anio).aggregate(Max('consumo_agua'))['consumo_agua__max']
